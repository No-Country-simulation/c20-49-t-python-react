    ...
    <div>
      ...
      <div>
        <p>
          ...
          San Juan. Se trataba de un criadero de aproximadamente 15 perros en
          estado de desnutrición y privados de su libertad.
        </p>
        <p>
        ...
        <p>
          ...
          los perros rescatados, nos pusimos en marcha en difundir y poco a poco
          organizar un espacio a aquellos animales que han pasado por la misma
          situación.
        </p>
      </div>
    </main>
